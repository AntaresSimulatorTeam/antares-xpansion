...
- If additional constraints are defined:
    - Create binary constraints, that represent for example exclusion constraints, see [**Figure 13**](https://antares-doc.readthedocs.io/en/latest/reference/xpansion-settings/#additional-constraints).
