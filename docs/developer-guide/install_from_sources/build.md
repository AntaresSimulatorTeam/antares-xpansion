...
Remember to set -DCMAKE_PREFIX_PATH to the path of the dependencies if using pre-built dependencies, such as Simulator or or-tools (see [this section](install-dependencies.md#using-pre-build-dependency)).
