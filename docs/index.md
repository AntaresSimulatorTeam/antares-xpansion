[![Ubuntu_CI_Status][ubuntu_system_svg]][ubuntu_system_link]  [![Windows_CI_Status][windows_vcpkg_svg]][windows_vcpkg_link] [![CentOS7_CI_Status][centos_system_svg]][centos_system_link] [![OL8_CI_Status][oracle_svg]][oracle_link] [![License](https://img.shields.io/badge/License-Apache%202.0-blue.svg)](https://opensource.org/licenses/Apache-2.0) [![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=AntaresSimulatorTeam_antares-xpansion&metric=alert_status)][sonarcloud_link]
