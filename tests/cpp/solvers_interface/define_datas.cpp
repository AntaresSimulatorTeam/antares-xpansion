...
void fill_datas(AllDatas& datas)
{
    ...
    multikp._col_names = {"x11", "x12", "x13", "x21", "x22", "x23", "x31", "x32", "x33"};
    ...
    auto test_equality = InstanceData();
    test_equality._path = data_test_dir / "mps" / "test_reduced_costs_equality.mps";
    test_equality._ncols = 3;
    test_equality._nintegervars = 0;
    test_equality._nrows = 1;
    test_equality._nelems = 3;
    test_equality._obj = {1.0, 2.7, 7.52};

    test_equality._matval = {2.0, 0.4, 1.0};
    test_equality._mind = {0, 1, 2};
    test_equality._mstart = {0, 3};

    test_equality._rhs = {4.32};
    test_equality._lb = {0.0, 0.0, 0.0};
    test_equality._ub = {1e20, 1e20, 1e20};
    test_equality._coltypes = {'C', 'C', 'C'};
    test_equality._rowtypes = {'E'};
    test_equality._optval = 2.16;
    test_equality._primals = {2.16, 0.0, 0.0};
    test_equality._duals = {0.5};
    test_equality._slacks = {0.0};
    test_equality._reduced_costs = {0.0, 2.5, 7.02};

    test_equality._status = {"OPTIMAL"};
    test_equality._status_int = {OPTIMAL};

    datas.push_back(test_equality);
}
