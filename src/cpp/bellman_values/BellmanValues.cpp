...
{
    auto variationDeNiveauxDeStockData = gridEvaluator.ComputeCosts(startWeek, endWeek);
    ...
    for (int scenario = 0; scenario < gridEvaluator.nbScenarios; ++scenario)
    {
