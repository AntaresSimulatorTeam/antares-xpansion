 ...
 * \param couplings map pairs and integer which give the correspondence between
 * optim variable and antares variable \return void
 */
void masterGeneration(
  ...
  master_l->write_prob_mps(
      (rootPath + PATH_SEPARATOR + "lp" + PATH_SEPARATOR + lp_name + ".mps"));
  ...
  std::ofstream coupling_file(
      (rootPath + PATH_SEPARATOR + "lp" + PATH_SEPARATOR + STRUCTURE_FILE)
          .c_str());
...
int main(int argc, char **argv) {
  ...
  try {
    ...
    std::string const xpansion_user_dir =
        root + PATH_SEPARATOR + ".." + PATH_SEPARATOR + ".." + PATH_SEPARATOR +
        "user" + PATH_SEPARATOR + "expansion";
    std::string const candidates_file_name =
        xpansion_user_dir + PATH_SEPARATOR + CANDIDATES_INI;
    std::string const capacity_folder =
        xpansion_user_dir + PATH_SEPARATOR + "capa";
