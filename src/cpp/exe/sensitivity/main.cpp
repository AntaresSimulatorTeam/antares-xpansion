...
int main(int argc, char **argv)
{
    ...
    try
    {
        ...
        SensitivityInputReader sensitivity_input_reader = SensitivityInputReader(last_master_mps_path, benders_out_json_path, epsilon);
