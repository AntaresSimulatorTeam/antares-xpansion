...
public:
    ...
    [[nodiscard]] virtual ProblemFormat Format() const = 0;
    ...
    class ConflictingParameters: public LogUtils::XpansionError<std::runtime_error>
    {
    ...
    class MismatchedParameters: public LogUtils::XpansionError<std::runtime_error>
    {
        using LogUtils::XpansionError<std::runtime_error>::XpansionError;
    ...
    public:
        explicit MissingParameters(const std::string& err_message, const std::string& log_location):
            XpansionError(err_message, log_location)
        {
        }
    };
