...
void AdditionalConstraints::constructAdditionalConstraints(std::string sectionName_l, std::map<std::string, std::string> const & constarintsSection_l)
{
    ...
    constraintName_l = checkAndReturnConstraintName(sectionName_l, constarintsSection_l);

    //check that section has defined a sign
    constraintSign_l = checkAndReturnSectionSign( sectionName_l, constarintsSection_l);

    //check that section has defined a rhs
    constraintRHS_l = checkAndReturnSectionRhs(sectionName_l, constarintsSection_l);
