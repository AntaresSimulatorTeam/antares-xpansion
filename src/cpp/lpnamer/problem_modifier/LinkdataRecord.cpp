...
{
    std::string row_l = std::to_string(fileColumns.directCapacity_) + sep_p + std::to_string(fileColumns.indirectCapacity_)
                    + sep_p + std::to_string(fileColumns.directHurdlesCost_) + sep_p + std::to_string(fileColumns.indirectHurdlesCost_) + sep_p + std::to_string(fileColumns.impedances_);
    if(modernAntaresVersion_)
    {
        row_l += sep_p + std::to_string(fileColumns.loopFlow_) + sep_p + std::to_string(fileColumns.pShiftMin_) + sep_p + std::to_string(fileColumns.pShiftMax_);
    }
