...
void ZipProblemProviderAdapter::reader_extract_file(const std::string& problem_name,
  ...
  SolverLogManager& solver_log_manager) const
{
    ...
    const auto lp_mps_name = ZipProblemProviderAdapter::lp_dir_
...
ZipProblemProviderAdapter::ZipProblemProviderAdapter(std::filesystem::path lp_dir,
