...
void MasterProblemBuilder::addPmaxConstraint(const std::vector<Candidate>& candidatesInteger,
...
int MasterProblemBuilder::getPmaxVarColumnNumberFor(const Candidate& candidate)
{
    ...
    {
        auto message = LOGLOCATION + "There is no Pvar for the candidate " + candidate.get_name();
