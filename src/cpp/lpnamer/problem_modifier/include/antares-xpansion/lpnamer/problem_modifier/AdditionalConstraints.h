 ...
 */
class AdditionalConstraints: public std::map<std::string, AdditionalConstraint>
{
private:
...
public:
    ...
    void SetConstraintsFile(const std::string& constraints_file_path)
    {
     ...
     * variable to link to
     */
    [[nodiscard]] const std::map<std::string, std::string>& getVariablesToBinarise() const;
