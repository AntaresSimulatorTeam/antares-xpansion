...
{
public:
    ProblemModifier(std::shared_ptr<ProblemGenerationLog::ProblemGenerationLogger> logger):
        logger_(logger)
    {
    }
    ...
    class CandidateWasNotAddedInProblem: public LogUtils::XpansionError<std::runtime_error>
    {
