...
bool Candidate::hasNullProfile(unsigned int chronicle, const std::set<int>& time_steps) const
{
    return std::all_of(time_steps.begin(),
                       time_steps.end(),
                       [this, chronicle](auto time_step)
                       {
