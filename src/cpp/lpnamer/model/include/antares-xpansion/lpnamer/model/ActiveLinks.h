...
public:
    ...
    [[nodiscard]] double already_installed_indirect_profile(size_t timeStep) const;
    [[nodiscard]] double already_installed_direct_profile(size_t chronicle_number,
                                                          size_t timeStep) const;
    [[nodiscard]] double already_installed_indirect_profile(size_t chronicle_number,
                                                            size_t timeStep) const;
...
public:
    ...
    class MultipleLinkIddetectedForLink: public LogUtils::XpansionError<std::runtime_error>
    {
        using LogUtils::XpansionError<std::runtime_error>::XpansionError;
    };

    class CandidateDuplicationDetected: public LogUtils::XpansionError<std::runtime_error>
    {
        using LogUtils::XpansionError<std::runtime_error>::XpansionError;
    };
