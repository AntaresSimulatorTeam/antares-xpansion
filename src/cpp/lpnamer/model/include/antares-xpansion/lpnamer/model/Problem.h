...
public:
    ...
    void init() override
    {
        solver_abstract_->init();
    }

    void free() override
    {
        solver_abstract_->free();
    }
    ...
    {
        solver_abstract_->set_obj_to_zero();
    }
    ...
    {
        solver_abstract_->get_rows(mstart, mclind, dmatval, size, nels, first, last);
    }
    ...
    {
        solver_abstract_
          ->add_rows(newrows, newnz, qrtype, rhs, range, mstart, mclind, dmatval, names);
    }
    ...
    void add_cols(int newcol,
                  ...
                  const std::vector<std::string>& names) override
    {
        solver_abstract_->add_cols(newcol, newnz, objx, mstart, mrwind, dmatval, bdl, bdu, names);
    }
