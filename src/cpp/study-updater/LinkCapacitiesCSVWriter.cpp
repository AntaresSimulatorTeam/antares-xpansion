...
LinkCapacitiesCSVWriter::LinkCapacitiesCSVWriter(const ActiveLink& link_p,
...
void LinkCapacitiesCSVWriter::WriteChronicleTimePoint(double direct_capacity,
                                                      double indirect_capacity)
{
    if (!new_timepoint_)
    {
        file_direct_ << "\t";
