...
void SensitivityMasterLogger::log_at_start(const SensitivityInputData& input_data)
{
    for (const auto& logger: _loggers)
    {
...
void SensitivityMasterLogger::log_begin_pb_resolution(const SinglePbData& pb_data)
{
    for (const auto& logger: _loggers)
    {
...
void SensitivityMasterLogger::log_summary(const SensitivityInputData& input_data,
