...
public:
     ...
     */
    virtual void write(BendersOptions const &bendersOptions_p) = 0;
     ...
     */
    virtual void write(int const &nbWeeks_p, BendersTrace const &bendersTrace_p, BendersData const &bendersData_p, double const &min_abs_gap, double const &min_rel_gap, double const &max_iter) = 0;
     ...
     */
    virtual void write(int nbWeeks_p, double const &lb_p, double const &ub_p, double const &investCost_p,
