...
void LastIterationWriter::SaveBestAndLastIterations(const LogData& best_iteration_log_data,
                                     ...
                                     const LogData& iteration_data)
{
    ...
    output_[iteration_name]["benders_elapsed_time"] = iteration_data.benders_elapsed_time;
    output_[iteration_name]["master_duration"] = iteration_data.master_time;
    output_[iteration_name]["subproblem_duration"] = iteration_data.subproblem_time;
