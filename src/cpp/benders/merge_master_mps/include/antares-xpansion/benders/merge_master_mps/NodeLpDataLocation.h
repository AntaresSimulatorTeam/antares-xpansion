...
// - In MultipleProblemGeneration when generating the file (this will ensures validity of a programmatically generated file)
...
{  
    ...
    NodeLpDataLocation(const std::filesystem::path& path) : lp_folder(path) {};
...
namespace LpDataLocationManager
{
    ...
    void write_nodal_lp_location_file(
